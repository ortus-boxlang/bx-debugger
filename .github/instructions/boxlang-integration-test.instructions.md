...
Each Java test file in the `src\test\java\ortus\boxlang\bxdebugger\boxlangIntegration` directory should have a corresponding boxlang file in the same directory.
...
- Use `[FullDebugSessionTest](../../src/test/java/ortus/boxlang/bxdebugger/FullDebugSessionTest.java)` as an example of how to structure your test. DO NOT MODIFY THIS FILE.
